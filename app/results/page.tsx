...
export default function ResultsPage() {
  ...
  const stats=[{icon:"✓",value:`${result.correctCount} / ${result.questionCount}`,label:"정답 수",tone:"soft-mint",color:"#46a302"},{icon:"↗",value:`${result.correctRate}%`,label:"정답률",tone:"soft-blue",color:"#168dcc"},{icon:"★",value:`${result.correctCount}개`,label:"획득한 별",tone:"soft-yellow",color:"#a57900"}];
  return <main className="page-shell"><div className="container"><header className="topbar"><Brand/><span className="pill">◷ {Math.max(1,Math.round(result.studySeconds/60))}분 학습</span></header><section className="mx-auto max-w-4xl pb-16 pt-7 text-center">
