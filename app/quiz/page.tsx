...
export default function QuizPage() {
  ...
  function replay(){if(question)playQuestionSpeech({url:question.ttsUrl,text:question.questionText,visemes:question.ttsVisemes}).catch(()=>setMessage("음성을 재생하지 못했어요."));}
